...
- [ ] Pure culture of fungal isolates
- [ ] Gloves
- [ ] Sharpie
- [ ] Thermal cycler
- [ ] Vortex
...
In this part of the module, you will extract DNA from your fungal isolates by boiling. There are many ways to isolate DNA from fungi. Here we will use a very simple extraction solution at high heat to disrupt cells and release gDNA.

#### Materials
- [ ] Pure culture of fungal isolates on PDA
- [ ] 0.2 mL PCR tubes
- [ ] P10, P200, P1000 micropipette with tips
- [ ] DNA extraction kit (New England BioLabs, Monarch® Spin gDNA Extraction Kit, T3010S)
- [ ] DNA quantification system (for example, Qubit Fluorometer with dsDNA HS Assay Kit, ThermoFisher, Q32851)
- [ ] Ethanol jar for sterilizing tools
- [ ] 70% ETOH
- [ ] Thermomixer
- [ ] NEB Q5 Hot Start High-Fidelity 2X Master Mix (M0494S) for PCR
- [ ] ITS primer pair
- [ ] Thermocycler
...
1. Create a spreadsheet to organize your data and metadata.
   - Include columns for sample name, date collected, location, substrate, PCR results, Sanger sequencing results, BLAST results, and any other relevant information.