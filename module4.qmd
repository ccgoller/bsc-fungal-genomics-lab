...
## Module 4.1 – ITS Amplification and Sanger Sequencing and Nanopore Sequencing Instructor Resources
...
1. Verify the primers are correct and received at 100 µM. Label the tubes as "Primer Stocks." 
2. Label the tube according to the primer being added.
3. Make 10 µM working stocks by diluting 20 µl of primer stock into 180 µl nuclease water. 
...
### Purpose
The purpose of this module is to molecularly identify fungal isolates using the Internal Transcribed Spacer **(ITS)** rDNA region, also known as the fungal barcode. You will extract genomic DNA (gDNA) from your isolates, amplify the ITS rDNA using polymerase chain reaction (PCR), clean the PCR product, Sanger sequence the PCR product, and use the DNA sequence to obtain a name for your isolate.
...
#### Introduction
Identification of fungal cultures requires knowledge and techniques beyond the scope of this course. Luckily, we can use DNA sequencing of the fungal barcode region (ITS rDNA) to identify our isolates. To do this, you must (1) extract gDNA from a pure culture of your fungal isolate; (2) specifically amplify (make millions of copies) a portion of the ITS rDNA region using polymerase chain reaction (PCR); (3) sequence the PCR product using Sanger sequencing; and (4) submit your sequences for comparison against an online gene database (NCBI's GenBank).
...
2. Transfer the collected mycelium to a PCR tube with 50 ul of water. Repeat this procedure for each of your isolates. Be sure to label your tubes with the name of the isolate and your name.
...
6. Carefully transfer 5 ul of the supernatant (which contains the DNA) to a new labeled PCR tube. 
7. Create a mastermix with your group that includes the following components for each reaction (25 µL total volume):
   - 12.50 µL of Q5 Hot Start High-Fidelity 2XMaster Mix
   - 1.25 µL of forward primer (10 pmol/µL)
   - 1.25 µL of reverse primer (10 pmol/µL)
   - 5.00 µL of nuclease free water

8. Aliquot 20 µL of your prepared mastermix into 0.2 mL snap-cap PCR tubes. 
9. Add 5 µL of your extracted DNA to the PCR tube containing the mastermix. Be sure to use a new pipette tip for each sample to avoid cross-contamination.
...
11. After the PCR program is complete, store your PCR products at -20 °C until you are ready to run gel electrophoresis to verify the success of your PCR reaction.
...
4. Remove and swirl after each interval. If you still see unmelted agarose, continue in 30-second intervals until completely melted. If the agarose starts to boil, stop the microwave immediately to prevent it from boiling over.
